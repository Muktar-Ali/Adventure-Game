...
from core.story_generator import Story_Generator
...
def generate_story_task(job_id: str, theme: str, session_id: str):
    ...
    try:
        ...
        try:
            ...
            story = Story_Generator.generate_story(db, session_id, theme)

            job.story_id = story.id  # replace with actual story id
